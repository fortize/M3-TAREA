...
students_mod <- subset(students,select = c(age,Medu,Fedu,traveltime,studytime,failures,famrel,freetime,goout))
...
train.students <- students[train.sample,]
test.students <- students[-train.sample,]
dim(train.students)
logistic.reg.model <- glm(Survived ~.,family=binomial,data=train.students)
